                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                         ...
                         {{-- <li class="nav-item">
                         <a class="nav-link" href="{{ route('transaksi.laporan') }}"><i class="fas fa-money-bill">Laporan Penjualan Tiket</i></a>
                        </li> --}}

                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="{{ route('transaksi.laporan') }}" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
